...
<main class="main">
      ...
      <div class="container">
        <div class="hero__content">
          <div class="wrapper">
            ...
            <button type="button" class="btn btn--lg btn--primary">What Are Your Values?</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="section section--about container">
    <div class="main__content row">
      <div class="column main-column-left">
        ...
        <div class="column-item">
          <h2 class="t-cta">Whole Child Education</h2>
      ...
      <div class="column main-column-right">
        <div class="column-item--right">
          <h1 class="t-cta">How Children Learn is as Important as What Children Learn</h1>
  ...
  <section class="section section--events">
    ...
    <div class="section__events row section__row">
      <div class="event event--first">
        <img src="https://res.cloudinary.com/ds0f4qyyt/image/upload/v1543413294/img-galler-left_zx7w3h.jpg" alt="event image" />
      ...
      <div class="event event--second">
        <img src="https://res.cloudinary.com/ds0f4qyyt/image/upload/v1543413292/img-gallery-center_phfu7m.jpg" alt="event image" />
        <h5 class="event__date">Nov 5 - 3:00 pm</h5>
        <h2 class="event__title">Event Name</h2>
        <p class="event__title">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
        <a class="link--important">Learn More</a>
      ...
      <div class="event event--third">
        <img src="https://res.cloudinary.com/ds0f4qyyt/image/upload/v1543413292/img-gallery-right_j5ivjk.jpg" alt="event image" />
        <h5 class="event__date">Nov 5 - 3:00 pm</h5>
        <h2 class="event__title">Event Name</h2>
        <p class="event__title">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
        <a class="link--important">Learn More</a>
